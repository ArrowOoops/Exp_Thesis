...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        print("before add_noise lm_logits = ", lm_logits)
        lm_logits = lm_logits + torch.normal(mean=0, std=0.5, size=lm_logits.shape)
        print("after add_noise lm_logits = ", lm_logits)
